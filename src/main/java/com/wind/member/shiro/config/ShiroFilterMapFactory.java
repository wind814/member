package com.wind.member.shiro.config;
...
//		设置路径映射，注意这里要用LinkedHashMap 保证有序
		...
		filterChainDefinitionMap.put("/v1/member/login/login", "anon");
		filterChainDefinitionMap.put("/v1/member/login/LoginOut", "logout");
		//放验证码
