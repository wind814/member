package com.wind.member.shiro.util;

import com.wind.member.entity.MemberUser;
import com.wind.member.shiro.service.MyShiroRealm;
...
public class ShiroUtils {
     ...
     */
    public static void setUser(MemberUser user)
    {
