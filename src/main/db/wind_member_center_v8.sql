...
INSERT INTO `member_permission` VALUES ('27', '订单列表', '订单列表', '/test', '0', '26', null, '1', 'fa fa-gear', '1', '0');
INSERT INTO `member_permission` VALUES ('28', '充值列表', '充值列表', null, '0', '26', null, '1', 'fa fa-gear', '1', '0');
INSERT INTO `member_permission` VALUES ('4', '用户管理', '用户展示', '/UserController/view', '0', '411522822607867904', 'system:user:view', '1', 'icon icon-user', '1', '0');
